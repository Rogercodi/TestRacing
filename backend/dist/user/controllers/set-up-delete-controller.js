...
exports.SetUpDeleteController = void 0;
const setupSchema_1 = require("../../models/setupSchema");
const userSchema_1 = require("../../models/userSchema");
class SetUpDeleteController {
    constructor() { }
    deleteSetUp(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let ref = req.params.referencia;
                console.log(ref);
                yield setupSchema_1.Setup.findOneAndDelete({ referencia: ref });
...
exports.SetUpDeleteController = SetUpDeleteController;
